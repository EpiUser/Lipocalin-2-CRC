...
** PROGRAM NAME: "Table 4_Linear association by waist and sex.sas"             *
...
*           evaluated overall and by sex and waist circumference categories.   *
*                                                                              *
...
*  factors. Also, the significance of interaction with waist circumference     *
*  categories is tested.                                                       *
*                                                                              *
...
PROC Freq data = Lipo_data;
  table Waist_cut*Sex*CACO / nocol nocum nopercent norow;
RUN; 
TITLE "Both sexes";
...
%HR_Phreg(data=Lipo_data(where=(Waist_cut = 1)), caseVar=CACO, timeVar=time_w, var=lipocalin2_log,
          covs=&covs &covs2_w, classVars=&covs_cat &covs2_cat,
          weights=sampling_weights);
%testInteraction(data=Lipo_data, caseVar=CACO, timeVar=time_w, var1=lipocalin2_log, var2=Waist_Adj,
                 covs=&covs &covs2_w, classVars=Waist_cut &covs_cat &covs2_cat, weights=sampling_weights);
TITLE "Men";
...
%HR_Phreg(data=Lipo_data_m(where=(Waist_cut = 1)), caseVar=CACO, timeVar=time_w, var=lipocalin2_log,
          covs=&covs &covs2_w, classVars=&covs_cat &covs2_cat,
          weights=sampling_weights);
%testInteraction(data=Lipo_data_m, caseVar=CACO, timeVar=time_w, var1=lipocalin2_log, var2=Waist_Adj,
                 covs=&covs &covs2_w, classVars=Waist_cut &covs_cat &covs2_cat, weights=sampling_weights);
TITLE "Women";
...
%HR_Phreg(data=Lipo_data_w(where=(Waist_cut = 1)), caseVar=CACO, timeVar=time_w, var=lipocalin2_log,
          covs=&covs &covs2_w, classVars=&covs_cat &covs2_cat,
          weights=sampling_weights);
%testInteraction(data=Lipo_data_w, caseVar=CACO, timeVar=time_w, var1=lipocalin2_log, var2=Waist_Adj,
                 covs=&covs &covs2_w, classVars=Waist_cut &covs_cat &covs2_cat, weights=sampling_weights);
...
PROC Freq data = Lipo_CC_data;
  table Waist_cut*Sex*CC_outcome / nocol nocum nopercent norow;
RUN; 
TITLE "Both sexes";
...
%HR_Phreg(data=Lipo_CC_data(where=(Waist_cut = 1)), caseVar=CC_outcome, timeVar=time_w, var=lipocalin2_log,
          covs=&covs &covs2_w, classVars=&covs_cat &covs2_cat,
          weights=sampling_weights);
%testInteraction(data=Lipo_CC_data, caseVar=CC_outcome, timeVar=time_w, var1=lipocalin2_log, var2=Waist_Adj,
                 covs=&covs &covs2_w, classVars=Waist_cut &covs_cat &covs2_cat, weights=sampling_weights);
TITLE "Men";
...
%HR_Phreg(data=Lipo_CC_data_m(where=(Waist_cut = 1)), caseVar=CC_outcome, timeVar=time_w, var=lipocalin2_log,
          covs=&covs &covs2_w, classVars=&covs_cat &covs2_cat,
          weights=sampling_weights);
%testInteraction(data=Lipo_CC_data_m, caseVar=CC_outcome, timeVar=time_w, var1=lipocalin2_log, var2=Waist_Adj,
                 covs=&covs &covs2_w, classVars=Waist_cut &covs_cat &covs2_cat, weights=sampling_weights);
TITLE "Women";
...
%HR_Phreg(data=Lipo_CC_data_w(where=(Waist_cut = 1)), caseVar=CC_outcome, timeVar=time_w, var=lipocalin2_log,
          covs=&covs &covs2_w, classVars=&covs_cat &covs2_cat,
          weights=sampling_weights);
%testInteraction(data=Lipo_CC_data_w, caseVar=CC_outcome, timeVar=time_w, var1=lipocalin2_log, var2=Waist_Adj,
                 covs=&covs &covs2_w, classVars=Waist_cut &covs_cat &covs2_cat, weights=sampling_weights);
...
PROC Freq data = Lipo_CC_prox_data;
  table Waist_cut*Sex*CC_prox_outcome / nocol nocum nopercent norow;
RUN; 
TITLE "Both sexes";
...
%HR_Phreg(data=Lipo_CC_prox_data(where=(Waist_cut = 1)), caseVar=CC_prox_outcome, timeVar=time_w, var=lipocalin2_log,
          covs=&covs &covs2_w, classVars=&covs_cat &covs2_cat,
          weights=sampling_weights);
%testInteraction(data=Lipo_CC_prox_data, caseVar=CC_prox_outcome, timeVar=time_w, var1=lipocalin2_log, var2=Waist_Adj,
                 covs=&covs &covs2_w, classVars=Waist_cut &covs_cat &covs2_cat, weights=sampling_weights);
TITLE "Men";
...
%HR_Phreg(data=Lipo_CC_prox_data_m(where=(Waist_cut = 1)), caseVar=CC_prox_outcome, timeVar=time_w, var=lipocalin2_log,
          covs=&covs &covs2_w, classVars=&covs_cat &covs2_cat,
          weights=sampling_weights);
%testInteraction(data=Lipo_CC_prox_data_m, caseVar=CC_prox_outcome, timeVar=time_w, var1=lipocalin2_log, var2=Waist_Adj,
                 covs=&covs &covs2_w, classVars=Waist_cut &covs_cat &covs2_cat, weights=sampling_weights);
TITLE "Women";
...
%HR_Phreg(data=Lipo_CC_prox_data_w(where=(Waist_cut = 1)), caseVar=CC_prox_outcome, timeVar=time_w, var=lipocalin2_log,
          covs=&covs &covs2_w, classVars=&covs_cat &covs2_cat,
          weights=sampling_weights);
%testInteraction(data=Lipo_CC_prox_data_w, caseVar=CC_prox_outcome, timeVar=time_w, var1=lipocalin2_log, var2=Waist_Adj,
                 covs=&covs &covs2_w, classVars=Waist_cut &covs_cat &covs2_cat, weights=sampling_weights);
...
PROC Freq data = Lipo_CC_dist_data;
  table Waist_cut*Sex*CC_dist_outcome / nocol nocum nopercent norow;
RUN; 
TITLE "Both sexes";
...
%HR_Phreg(data=Lipo_CC_dist_data(where=(Waist_cut = 1)), caseVar=CC_dist_outcome, timeVar=time_w, var=lipocalin2_log,
          covs=&covs &covs2_w, classVars=&covs_cat &covs2_cat,
          weights=sampling_weights);
%testInteraction(data=Lipo_CC_dist_data, caseVar=CC_dist_outcome, timeVar=time_w, var1=lipocalin2_log, var2=Waist_Adj,
                 covs=&covs &covs2_w, classVars=Waist_cut &covs_cat &covs2_cat, weights=sampling_weights);
TITLE "Men";
...
%HR_Phreg(data=Lipo_CC_dist_data_m(where=(Waist_cut = 1)), caseVar=CC_dist_outcome, timeVar=time_w, var=lipocalin2_log,
          covs=&covs &covs2_w, classVars=&covs_cat &covs2_cat,
          weights=sampling_weights);
%testInteraction(data=Lipo_CC_dist_data_m, caseVar=CC_dist_outcome, timeVar=time_w, var1=lipocalin2_log, var2=Waist_Adj,
                 covs=&covs &covs2_w, classVars=Waist_cut &covs_cat &covs2_cat, weights=sampling_weights);
TITLE "Women";
...
%HR_Phreg(data=Lipo_CC_dist_data_w(where=(Waist_cut = 1)), caseVar=CC_dist_outcome, timeVar=time_w, var=lipocalin2_log,
          covs=&covs &covs2_w, classVars=&covs_cat &covs2_cat,
          weights=sampling_weights);
%testInteraction(data=Lipo_CC_dist_data_w, caseVar=CC_dist_outcome, timeVar=time_w, var1=lipocalin2_log, var2=Waist_Adj,
                 covs=&covs &covs2_w, classVars=Waist_cut &covs_cat &covs2_cat, weights=sampling_weights);
...
PROC Freq data = Lipo_RC_data;
  table Waist_cut*Sex*RC_outcome / nocol nocum nopercent norow;
RUN; 
TITLE "Both sexes";
...
%HR_Phreg(data=Lipo_RC_data(where=(Waist_cut = 1)), caseVar=RC_outcome, timeVar=time_w, var=lipocalin2_log,
          covs=&covs &covs2_w, classVars=&covs_cat &covs2_cat,
          weights=sampling_weights);
%testInteraction(data=Lipo_RC_data, caseVar=RC_outcome, timeVar=time_w, var1=lipocalin2_log, var2=Waist_Adj,
                 covs=&covs &covs2_w, classVars=Waist_cut &covs_cat &covs2_cat, weights=sampling_weights);
TITLE "Men";
...
%HR_Phreg(data=Lipo_RC_data_m(where=(Waist_cut = 1)), caseVar=RC_outcome, timeVar=time_w, var=lipocalin2_log,
          covs=&covs &covs2_w, classVars=&covs_cat &covs2_cat,
          weights=sampling_weights);
%testInteraction(data=Lipo_RC_data_m, caseVar=RC_outcome, timeVar=time_w, var1=lipocalin2_log, var2=Waist_Adj,
                 covs=&covs &covs2_w, classVars=Waist_cut &covs_cat &covs2_cat, weights=sampling_weights);
TITLE "Women";
...
%HR_Phreg(data=Lipo_RC_data_w(where=(Waist_cut = 1)), caseVar=RC_outcome, timeVar=time_w, var=lipocalin2_log,
          covs=&covs &covs2_w, classVars=&covs_cat &covs2_cat,
          weights=sampling_weights);
%testInteraction(data=Lipo_RC_data_w, caseVar=RC_outcome, timeVar=time_w, var1=lipocalin2_log, var2=Waist_Adj,
                 covs=&covs &covs2_w, classVars=Waist_cut &covs_cat &covs2_cat, weights=sampling_weights);
