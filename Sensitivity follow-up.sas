...
** PROGRAM NAME: "Sensitivity follow-up.sas"                                   *
...
*  and matched controls with a follow-up time of less than 2 years. Hazard     *
*  ratios are caculated for an adjusted model, including all matching factors  *
*  and additional anthropometry and lifestyle factors.                         *
*                                                                              *
...
DATA Lipo_data; set Lipo_data;
  if time_w < 2 then delete; * exclude participants with less than 2 years follow-up;
RUN;
